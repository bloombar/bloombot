 ...
 * `GET /guilds/{id}/members` (ROST-10/ROST-11), which
 * `apps/worker/src/handlers/roster-import.ts` calls to resolve a roster
 * row's Discord handle. Bound to `127.0.0.1:0` so the OS picks a free port
 * and no test reaches the real network. Duplicated from
 * `apps/worker/tests/helpers/fake-discord-guild-server.ts` (itself
