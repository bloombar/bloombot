 ...
 * test file — the same shape `packages/db/tests/helpers/test-db.ts` and
 * `packages/actions/tests/helpers/test-db.ts` use, duplicated here rather
...
const TMP_ROOT = join(process.cwd(), 'tmp', 'auth-tests')
