  ...
  it('found the routes this test is written against — a new one changes this count', () => {
    ...
    expect(ALL_ROUTES.map((r) => r.routeName).sort()).toEqual(
      [
        ...
        'POST /organizations/:organizationId/actions/jobs.list',
        'POST /organizations/:organizationId/actions/roster.import',
        'POST /organizations/:organizationId/actions/rosterAcknowledgements.listForCourse',
        ...
        'POST /organizations/:organizationId/actions/memberships.revoke',
        // WEB-58 — added by this slice.
        'POST /organizations/:organizationId/actions/memberships.leave',
