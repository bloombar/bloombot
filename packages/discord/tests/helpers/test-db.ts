 ...
 * test file — the same shape `packages/core/tests/helpers/test-db.ts` and
 * `packages/db/tests/helpers/test-db.ts` use, duplicated here rather than
...
const TMP_ROOT = join(process.cwd(), 'tmp', 'discord-tests')
