...
export const MILESTONE_TITLE = {
  ...
  27: "Phase 27 — Asking a course's assistant from an MCP client",
  28: 'Phase 28 — A message the bot never received',
  ...
  33: 'Phase 33 — Deleting a project or a course',
  34: 'Phase 34 — A category that routes however it is typed',
  35: 'Phase 35 — Knowing who is enrolled',
  36: 'Phase 36 — Approving a course before it answers',
...
export const FAMILY_LABEL = {
  ...
  PORT: {
    ...
    color: '8a63d2',
    description: 'Exporting and importing course & project configuration',
  },
}
